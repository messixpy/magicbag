    ...
    <>
     <div style={{display:showNav&&'none'}}  className=" flex  flex-col vh-100 lg:ml-12 justify-center items-center w-[100%] lg:w-[78%] ">
        {/* <div className="flex flex-col lg:flex-row  w-[92%] lg:w-[100%]  justify-around  md:gap-3 p-1 "> */}
          ...
          <div className={`${showNav ? "hidden" : "flex"} md:border-2 lg:flex-row flex-col items-center justify-around md:p-[0.2rem] md:border-white md:rounded-md  w-[100%] `}>
            <div className=" flex flex-col px-4 my-2 w-[95%] lg:w-[35%]">
              <img src={comingsoon} alt="comming soon" />
            </div>
            <div className=" flex justify-center items-center border border-white h-fit my-4 w-[95%] lg:w-[35%]">
              <video
                src={staking}
                width="800"
                height="400"
