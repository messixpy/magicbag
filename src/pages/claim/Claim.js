  ...
  const gData = [
    ...
    },
    {
      ...
      price1: `$ ${
        address && felixDollarRate && ethDollarRate
          ? (
              Number(felixDollarRate) * (felixBalance / 10 ** decimals)
            ).toFixed(9)
          : 0
      }`,
      price: `${
                      ...
                      >
                        ...
                        <div className=" flex lg:flex-row flex-col  gap-3 ">
                          <input
                            ...
                            autoComplete="off"
                            onChange={handleInputChange} // Add onChange event to handle input change
                          />
                          <div className="flex   lg:w-[28%] justify-between">
                            <button
                              ...
                              onClick={validate} // Add onClick event to call the validate function
                              disabled={validatingState} // Disable the button while validating
                            >
                              {validatingState ? "Validating..." : "Validate"}
                            </button>
