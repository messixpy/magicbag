...
const SkeletonLoadingStakingHeadline = () => {
...
const StakingHeadline = () => {
  ...
  const texts = ["STAKING", "MAGIC BAG", "STAKING", "MAGIC BAG", "STAKING", "MAGIC BAG", "STAKING", "MAGIC BAG", "STAKING", "MAGIC BAG"];

  if (isLoading) {
    return <SkeletonLoadingStakingHeadline />;
  }
